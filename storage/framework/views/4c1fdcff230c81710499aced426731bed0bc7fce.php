<?php $__env->startSection('content'); ?>
    ...
    <form autocomplete="false" id="book-form">
        <input type="hidden" value="<?php echo e($bookData->id); ?>" name="id">
        <fieldset>
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <input type="text" name="book_name" class="form-control" required value="<?php echo e($bookData->book_name); ?>">
            </div>
            <div class="form-group">
                <label for="booknameInput">Book Year *</label>
                <input type="number" name="book_year" class="form-control" required value="<?php echo e($bookData->book_year); ?>">
            </div>
        </fieldset>
        <br>
        <fieldset>
            ...
            <div id="new-library-section">
                <div class="multi-rows">
                    <?php $__currentLoopData = $bookData->book_library; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="row multirows" id="row-<?php echo e($key + 1); ?>">
                            <div class="form-group col-md-5">
                                <label for="booknameInput">Library Name</label>
                                <input type="text" name="library_name[]" value="<?php echo e($val->library->library_name); ?>"
                                    id="libraryname-<?php echo e($key + 1); ?>" class="form-control name">
                            </div>
                            <div class="form-group col-md-5">
                                <label for="booknameInput">Library Address</label>
                                <input type="text" name="library_address[]"
                                    value="<?php echo e($val->library->library_address); ?>" id="libraryaddress-<?php echo e($key + 1); ?>"
                                    class="form-control address">
                            </div>
                            <div class="form-group col-md-2">
                                <label></label>
                                <button type="button" class="btn btn-danger deletebtn" id="delete-<?php echo e($key + 1); ?>"
...
<?php $__env->startPush('scripts'); ?>
    <script>
        const update_books_url = '<?php echo route('book.update', $bookData->id); ?>';
        const library_id = '<?php echo count($bookData->book_library) > 0 ? $bookData->book_library[0]->id : ''; ?>';
        const author_id = '<?php echo $bookData->author->id; ?>';
        const fetch_author_libraries_url = '<?php echo route('book.fetch-authors-libraries'); ?>';
        const edit_data = '<?php echo $bookData; ?>';
        alert(update_books_url);
        var datas = JSON.parse(edit_data);
// http://library-demo-main.test/api/book/3
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tccrmapi/public_html/resources/views/books/edit.blade.php ENDPATH**/ ?>